...
namespace UDPServerTest.Decode
{
    public class DecodeRTPHelper
    {
        ...
        public static byte[] DecodeSingleNalu(byte[] sourceRtpPackage, int length, ref int index, ref int iDRFrameCount)
        {
        ...
        public static byte[] DecodeFregmentNalu(byte[] sourceRtpPackage, byte[] startCode, byte[] fregmentBuffer, int length,
            ref int fregmentNaluLength, ref int fuIndicatorTop3Bit, ref int fuHeaderLast5Bit,ref int iDRFrameCount,ref int videoSequenceIndex)
        {
        ...
        /// <summary>
        /// 将spsBuffer  iFrameSequenceBuffer等复制进H264Buffer
        /// </summary>
        /// <param name="H264Bytes">H264Buffer</param>
        /// <param name="sourceBytes">spsBuffer或iFrameSequenceBuffer</param>
        /// <param name="sourceBytesLength">spsBuffer或iFrameSequenceBuffer中数据的有效长度</param>
        /// <param name="index">H264Buffer中的索引位置</param>
        public static void CopyToH264(byte[] H264Bytes, byte[] sourceBytes, int sourceBytesLength, ref int index)
        {
            Array.Copy(sourceBytes, 0, H264Bytes, index, sourceBytesLength);
        }
